            ...
            {rightOpen && (
              ...
              >
                ...
                <DropdownMenu variant="light" aria-label="Static Actions">
                  <DropdownItem
                    className="bg-[#3fafa8] text-white rounded-full text-center shadow my-2 hover:bg-[#116661]"
                  ...
                  <DropdownItem
                    ...
                    // }}
                    className="bg-[#3fafa8] text-white rounded-full text-center shadow hover:bg-[#116661]"
                    classNames={{
                      title: "text-lg font-bold px-4 text-white",
                    }}
                    key="detect"
