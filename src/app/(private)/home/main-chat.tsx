  ...
  return (
    <div className="flex flex-row flex-wrap items-center justify-center gap-2">
      {suggestions.map((suggestion) => (
        <Button
          key={suggestion.id}
          className="h-8 gap-2 bg-white rounded-full px-3 text-default-700 transition-colors !duration-350  hover:text-default-700 data-[hover=true]:text-default-700 shadow-lg"
          startContent={
            <Icon
...
export default function MainChat() {
  ...
  return (
    <>
      <div className="flex flex-col w-full items-center justify-center pt-24 z-50">
        <div
            ...
            {messages.length === 0 && (
              <div className="flex items-center justify-center absolute top-8 left-1/2 transform -translate-x-1/2 z-0 h-max-[100px]">
                <Image
                  ...
                  width={330}
                  height={400}
                  className="z-0 filter hue-rotate-180"
                />
                <div className="absolute top-[160px] left-[300px] h-4 w-4 bg-white/90 rounded-full shadow-lg"></div>
                <div className="absolute top-[155px] left-[280px] h-2 w-2 bg-white/90 rounded-full shadow-lg"></div>
                <div className="p-4 mr-12 rounded-2xl bg-white shadow-lg">
