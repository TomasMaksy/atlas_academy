...
import { useEssay } from "@/app/(private)/chat/essay-context";
...
export default function useWebRTCAudioSession(
  ...
  You are interviewing a student named Martin for university admissions. 
  ...
  Start the first time with greeting and name.

  Provided essay: 
  TITLE: ${essay?.title}
  CONTENT: ${essay?.__html}
  `;
  // const systemPrompt = "Always respond in english."
