			...
			(item: SidebarItem) => {
				...
				return (
					...
					>
						{isCompact ? (
							<Tooltip content={item.title} placement="right">
								<div className="flex w-full items-center justify-center aria-label={item.title}">
									{item.icon ? (
										<Icon
											className={cn(
												"text-default-500 group-data-[selected=true]:text-foreground",
		...
		return (
			<Listbox
				...
				itemClasses={{
					...itemClasses,
					base: cn(
						"px-3 min-h-11 rounded-large h-[44px] data-[selected=true]:bg-[#3fafa8]/20 data-[hover=true]:bg-[#3fafa8]/10",
						itemClasses?.base
					),
					title: cn(
